...
[rhdm73-prod-immutable-kieserver](https://github.com/jboss-container-images/rhdm-7-openshift-image/blob/master/templates/rhdm73-prod-immutable-kieserver.yaml)
