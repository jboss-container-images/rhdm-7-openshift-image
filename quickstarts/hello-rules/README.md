...
First of all, install this quickstart on OpenShift using the [rhdm78-prod-immutable-kieserver-amq.yaml](../../templates/rhdm78-prod-immutable-kieserver-amq.yaml)
