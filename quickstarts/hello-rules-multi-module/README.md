...
To deploy the Hello Rules demo you can use the [rhdm79-prod-immutable-kieserver](https://github.com/jboss-container-images/rhdm-7-openshift-image/blob/master/templates/rhdm79-prod-immutable-kieserver.yaml)
